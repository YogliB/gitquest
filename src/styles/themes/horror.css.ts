...
globalStyle('[data-theme="horror"] .landing-bg, [data-theme="horror"] .style-bg, [data-theme="horror"] .game-bg', {
  background: 'radial-gradient(ellipse at 30% 70%, rgba(204, 26, 26, 0.06) 0%, transparent 50%), radial-gradient(ellipse at 70% 30%, rgba(107, 0, 107, 0.04) 0%, transparent 50%)',
})
