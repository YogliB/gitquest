    ...
    <div className={styles.backdrop} onClick={e => { if (e.target === e.currentTarget) onClose() }}>
      <div className={styles.content}>
        ...
        <div className={styles.menuButtons}>
          <Button variant="primary" onClick={() => { onSave(); onClose() }}>💾 Save Quest</Button>
          <Button variant="secondary" onClick={() => navigate(-1)}>🔄 Change Style</Button>
          <Button variant="ghost" onClick={() => navigate('/')}>🏠 New Repository</Button>
        </div>
