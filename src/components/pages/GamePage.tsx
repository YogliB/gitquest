...
export function GamePage() {
  ...
  const {
    gameState, setGameState, isGenerating, setIsGenerating,
    githubToken, currentStyle, setCurrentStyle,
    isPlaying, volume, setIsPlaying, setVolume, musicStarted, setMusicStarted,
  } = useStore()
