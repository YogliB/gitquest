...
export interface SettingsSlice {
  ...
  saveSettings: (partial: Partial<Omit<SettingsSlice, 'rateLimit' | 'saveSettings' | 'setRateLimit'>>) => void
...
export function createSettingsSlice(set: (fn: (state: SettingsSlice) => Partial<SettingsSlice>) => void): SettingsSlice {
